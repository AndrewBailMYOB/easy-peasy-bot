...
controller.hears(['Greeting'], ['mention', 'direct_mention', 'direct_message'], apiai.hears, function (bot, message) {
...
controller.hears(['nerd'], ['direct_message'] , apiai.hears, function (bot, message) {
    bot.reply(message, 'NERD!!');
});
